...
if __name__ == '__main__':
    #os.system('rm data/ImageSets/Main/*')
    #os.system('rm data/labels/*')
    #os.system('rm data/test.txt')
    #os.system('rm data/train.txt')
    #os.system('rm data/labels.cache')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default='', help='resume most recent training') #runs/train/exp39/weights/last.pt
